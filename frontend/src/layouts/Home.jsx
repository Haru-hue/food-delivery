    ...
    {isOrderDeclinedInURL &&( <AnimatedWrongMark />)}
      ...
      <section className="about-section pb-4">
        ...
        <div class="text-center">
          <span class="inline-block w-500 title-font text-5xl leading-[3.5rem]">
      ...
      <section className="work-section">
        <h1 className="font-bold title-font text-5xl text-center py-6">
          How It Works?
        </h1>
        <div className="columns-2 gap-4">
          <img src={worker} alt="" className="w-1/2 ml-auto" />
          <article>
            <p className="text-2xl font-semibold w-[375px]">
      ...
      <section className="food-banner pt-24">
        <div className="grid grid-cols-2 gap-6">
          <div
            className="w-[35rem] h-[38rem] ml-auto bg-cover bg-center rounded-xl"
            style={{ backgroundImage: `url(${shawarma})` }}
          >
            1
          </div>
          <div>
